...
if ENV:
    ...
    from SparrowRobot.config import Development as Config
...
pbot = Client("sparrowRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN , plugins=dict(root= "SparrowRobot.handlers"))
...
from SparrowRobot.modules.helper_funcs.handlers import (
